...
export default function AlertWait({size, style}) {
  return (
    <Svg viewBox="0 0 500 500" height={size} width={size}>
      ...
      <G id="freepik--Character--inject-2">
        ...
        />
        <Circle cx="214.67" cy="92.82" r="8.15" fill="#D9412C" />
        <Path
        ...
        <Ellipse
          ...
          fill="#D9412C"
        />
        <Circle cx="252.85" cy="92.82" r="8.15" fill="gray" />
        <Polygon
          ...
          fill="#263238"
        />
        <Circle cx="233.87" cy="92.82" r="8.15" fill="gray" />
        <Polygon
      ...
      <G id="freepik--Table--inject-2">
        ...
        <Rect
          ...
          stroke-linejoin="round"
        />
        <Rect x="82.89" y="293.19" width="212.25" height="7.3" fill="#263238" />
        <Rect
          x="72.45"
          y="282.54"
          width="226.46"
